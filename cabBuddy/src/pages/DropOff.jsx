...
export default function DropoffPage() {
  ...
  const filtered = dropoffSuggestions.filter((s) =>
      ...
      <div className="w-full max-w-3xl space-y-6">
        ...
        <Command className="rounded-3xl border bg-white shadow-md">
          ...
          <div className="px-0 pb-0 pt-3 md:px-0">
            <Button 
            onClick={gotoRouteVal}
            className="h-14 w-full rounded-b-3xl rounded-t-none bg-[#00aff5] hover:bg-[#0092cc] text-base font-semibold text-white">
              Save
            </Button>
          </div>
        </Command>
